...
$sql = "select orden.*, estado.DESCRIPCION as std, chofer.NOMBRE as chfr, cliente.NOMBRE as clnt from orden left join chofer on orden.RUT_CHOFER=chofer.RUT left join cliente on orden.RUT_CLIENTE=cliente.RUT left join estado ON orden.ESTADO=estado.ID where estado=2 and orden.id=".$q;
...
<head>
  ...
  <script>
    function openConfirmation(){
      ...
      valor01 = new Date(document.getElementById("idFechaEntrega").value);
      if(valor01=="" || isNaN(valor01) ) {
        txtError="Ingrese una Fecha de Entrega.";
      }

      valorTxt = document.getElementById("idNombreRecibe").value;
      if( valorTxt == null || valorTxt.length == 0 || /^\s+$/.test(valorTxt) ) {
        txtError="Ingrese un Nombre de Receptor.";
      }
      valorTxt = document.getElementById("idRutRecibe").value;
      if( valorTxt == null || valorTxt.length == 0 || /^\s+$/.test(valorTxt) ) {
        txtError="Ingrese un RUT de Receptor.";
      }
          ...
          <div class="container-fluid">
            <div class="header-wrap">
              <form class="form-header" action="" method="POST">
                <h2 class="title-1">Entregar Orden Transporte</h2>
                <!-- <input class="au-input au-input--xl" type="text" name="search" placeholder="Search for datas &amp; reports..." /> -->
                                ...
                                <!-- MAIN CONTENT-->
                                <form id="frmDatos" name="frmDatos" method="POST" action="saveEntregarOrden.php">
                                    ...
                                    <div class="section__content section__content--p30">
                                      <div class="container-fluid">
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="card-body card-block">
                                                <div class="form-group">
                                                  ...
                                                  <input type="date" id="idFechaEntrega" name="idFechaEntrega" placeholder="Fecha Entrega" class="form-control">
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="card-body card-block">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" id="idNombreRecibe" name="idNombreRecibe" placeholder="Nombre quien recibe" class="form-control">
                                                </div>

                                                <div class="form-group">
                                                  <label for="vat" class=" form-control-label">Rut Recibe</label>
                                                  <input type="text" id="idRutRecibe" name="idRutRecibe" placeholder="Rut quien Recibe" class="form-control">
                                        ...
                                        <div class="card-footer">
                                          ...
                                          <button type="button" onclick="openConfirmation();" class="btn btn-success btn-sm">Registrar Entrega</button>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>
                                    ¿Esta seguro de realizar la entrega de la Orden de Transporte?
                                  </p>
                                </div>
