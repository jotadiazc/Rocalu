  ...
  <script>
    function openConfirmation(){
      ...
      if(valor01=="" || isNaN(valor01) ) {
        txtError="Ingrese una Fecha para el Egreso.";
      }
                          ...
                          <div class="account-wrap">
                            <div class="account-item clearfix js-item-menu">
                                ...
                                <div class="main-content">
                                  <div class="section__content section__content--p30">
                                    <div class="container-fluid">
                                      <form action="saveRegistrarEgreso.php" id="formulario" method="POST">
                                        <div class="row">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-12 col-md-9">
                                            <select name="idConcepto" id="idConcepto" class="form-control">
                                              ...
                                              $qry='SELECT * FROM concepto WHERE TIPO=2';
                                ...
                                <div>
                                  <button id="idBotonGenerarOrden" type="button" onclick="openConfirmation();" class="btn btn-lg btn-info btn-block">
                                    ...
                                    <span id="payment-button-amount">Guardar Egreso</span>
                ...
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>
                        ¿Esta seguro de guardar el nuevo Egreso?
                      </p>
                    </div>
