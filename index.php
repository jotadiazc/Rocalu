            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a href="index.php" class="js-arrow" href="#">
                            ...
                            <li class="has-sub">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a href="crearRuta.php">
                                            <i class="fas fa-address-book"></i>Crear Ruta</a>
                                        </li>


                                <li>
                                    <a href="listadoOrdenes.php">
                                        <i class="fas fa-table"></i>Otros Ingresos</a>
                                </li>
                            ...
                            <nav class="navbar-sidebar">
                                <ul class="list-unstyled navbar__list">
                                    <li class="active has-sub">
                                        <a href="index.html" class="js-arrow" href="#">
                                            <i class="fas fa-tachometer-alt"></i>Inicio</a>
                                        </li>
                                                            ...
                                                            <div class="account-item clearfix js-item-menu">
                                                                ...
                                                                <div class="account-dropdown js-dropdown">
                                                                    <!-- <div class="info clearfix">
                                                                        ...
                                                                        <div class="content">
                                                                            <h5 class="name">
                                                                                <a href="#">Javier Diaz</a>
                                                                            </h5>
                                                                            <span class="email">jvierdiaz@correo.com</span>
                                                                        </div>
                                                                    </div> -->
